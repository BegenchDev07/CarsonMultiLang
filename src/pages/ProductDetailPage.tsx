...
const ProductDetailPage = () => {
  ...
  return (
    <>      
      <div className={`pt-10 min-h-screen ${isRTL ? 'rtl' : 'ltr'}  bg-[#d9d9d9] px-2 text-black`}>      
        {/* {
          isModalOpen
          &&
          <div 
        ...
        <div className={`max-w-7xl mx-auto sm:px-6 lg:px-8 py-8 mb-20 ${isRTL ? 'text-right' : 'text-left'}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className='h-auto'>
              ...
              {allImages.length > 1 && (
                renderGallery(allImages,product.product_name)
              )}
            </div>
            ...
            <div>
              <div className="bg-white rounded-2xl p-8 shadow-lg">
                  ...
                  <div className="mb-6">
                    ...
                    {/* <div className={`w-full bg-white p-2 text-[#7b7b7b] hover:*:text-[#d60000] flex items-center justify-evenly ${ isMobile ? 'hidden' : '' }`}>
